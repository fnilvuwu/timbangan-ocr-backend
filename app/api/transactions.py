...
async def capture_inbound(
    ...
    now = datetime.utcnow()
    inbound_captured_path = await save_image_file(capture_file, now, prefix="inbound")
...
async def capture_outbound(
    ...
    now = datetime.utcnow()
    outbound_captured_path = await save_image_file(capture_file, now, prefix="outbound")
